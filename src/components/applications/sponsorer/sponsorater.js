          ...
          <div className="col-sm-12">
            <div className="card">
              <div className="card-header">
                <h3>Sponsorater</h3>
                <p>Her kan du se en oversigt over dine sponsorater. Du kan filtrer i sponsoraterne og se hvilke de er aktive og ikke aktive.
                  Det er også muligt at se sponsoratet som er sendt til sponsoren, redigere det og slette det.
                </p>
              </div>
            </div> 
         
            <DropdownButton className="sponsorat-dropdown" id="dropdown-basic-button" title={buttonText} onSelect={toggle}>
