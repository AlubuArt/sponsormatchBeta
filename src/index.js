        ...
        <Switch>
          ...
          {userID !== null ? (
            <App>
              ...
              <Route
                path={`${process.env.PUBLIC_URL}/forside`}
                render={() => <Default us={userID} />}
              />
              ...
              {/* Learning App */}
              <Route
                path={`${process.env.PUBLIC_URL}/kursus-samling`}
                component={LearningList}
              />
              <Route
                path={`${process.env.PUBLIC_URL}/kursus-detaljer`}
                component={LearningDeatil}
              />

              {/* Sponsor pages */}
              <Route
                path={`${process.env.PUBLIC_URL}/vores-sponsorer`}
                component={SponsorContacts}
              />
              <Route
                path={`${process.env.PUBLIC_URL}/sponsorater`}
                component={Sponsorater}
              />
              <Route
                path={`${process.env.PUBLIC_URL}/soeg-sponsor`}
                component={SponsorSearch}
              />
              <Route
                path={`${process.env.PUBLIC_URL}/opret-sponsorat`}
                component={OpretSponsorat}
              />
              <Route
                path={`${process.env.PUBLIC_URL}/sponsor-matches`}
                component={SponsorMatches}
              />

              {/* Sample page */}
              <Route
                path={`${process.env.PUBLIC_URL}/feedback/feedbackpage`}
